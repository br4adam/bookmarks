...
const App = () => {
  ...
  return (
    <div className="relative flex flex-col pb-12 text-zinc-200 bg-zinc-950 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] bg-[length:1200px_800px] from-zinc-900 to-40% to-transparent bg-top bg-no-repeat selection:bg-zinc-500/20 antialiased">
      <Header />
